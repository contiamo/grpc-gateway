 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return interface{}*/
func (a *ABitOfEverythingServiceApiService) GetQuery(ctx context.Context, uuid string, floatValue float32, localVarOptionals map[string]interface{}) (interface{},  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param body 
 @return interface{}*/
func (a *ABitOfEverythingServiceApiService) PatchWithFieldMaskInBody(ctx context.Context, abeUuid string, body ExamplepbUpdateV2Request) (interface{},  *http.Response, error) {
	var (
